  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-16 md:mb-24 animate-fade-in-up">
        ...
        <div className="rounded-lg overflow-hidden shadow-soft-lg border border-brand-border aspect-video">
      ...
      <div className="my-16 md:my-24 animate-fade-in-up">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={value.title} className="bg-brand-surface p-6 rounded-xl text-center transform transition-all duration-200 hover:bg-brand-primary/5 hover:scale-105 shadow-soft border border-brand-border flex flex-col items-center">
      ...
      <div className="my-16 md:my-24 animate-fade-in-up">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map(member => (
            <div key={member.name} className="bg-brand-surface p-6 rounded-xl shadow-soft text-center transform transition-all duration-200 hover:shadow-soft-lg hover:-translate-y-1 border border-brand-border">
